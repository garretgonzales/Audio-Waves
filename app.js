...
function initialize() {
    ...
    audioctx = new AudioContext(); // Audio analyzer pickup (freq)
...
audioFile.onchange = function () { // Upload Audio functionality 
    audio = document.getElementById("audio");
    var reader = new FileReader();
    reader.onload = function (event) {
        audio.src = this.result;
        audio.controls = true;
        audio.crossOrigin = "anonymous"; // wtf CORS
